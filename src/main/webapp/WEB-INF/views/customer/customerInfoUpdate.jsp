		...
		<div class="main-content-inner">
			...
			<div class="page-content">
				<div class="page-header">
					<h1>
						客户信息
						<small><i class="ace-icon fa fa-angle-double-right"></i> 修改客户信息
						</small>
					</h1>
				</div>
				<!-- /.page-header -->
					...
					<div class="col-xs-12">
						<form id="moduleForm" name="moduleForm" class="form-horizontal" action="update.htm"
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">客户身份id：</label>
								<div class="col-sm-9">
									<input id="id" type="text" class="col-xs-10 col-sm-5" placeholder=""
										   value="${customerInfo.id}" readonly>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input id="address" name="address" type="text" class="col-xs-10 col-sm-5" placeholder=""
										   value="${customerInfo.address}"
										   maxlength="20"> <label id="addressTip"></label>
								</div>
							</div>
